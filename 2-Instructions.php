...
<ul>
 ...
 <li>The input needs to be <b>comma separated, with headers: A1,A2,A3,B1,B2,B3 </b></li>
 ...
 <li>If labels are provided, the column header must be A1,A2,A3,B1,B2,B3,label
 <li>Additional columns that will not be used by the program (for example indices, etc.) can be added, but only columns with the column names A1,A2,A3,B1,B2,B3 are required.</li>
